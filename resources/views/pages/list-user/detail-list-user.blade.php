                                    ...
                                    @foreach ($users as $us)
                                        @if ($list['user_id'] == $us['id'])
                                            <div class="col-md-4 remove-item">
                                                ...
                                                <div class="job-item">
                                                    <a  onclick="return xoaSanPham();" href="{{ route('company.get.deleteuser', $list->id) }}"><span id="confirm" class="remove-icon"><i class="fa fa-times"
                                                                aria-hidden="true"></i></span></a>
                                                    <div class="job-info">
                                                        <div class="company-logo">
                                                            <center><img src="images/users/{{ $us->avatar }}"
                                                                    style="border-radius: 20000px;" width="150"     >
                                                            </center>
                                                        </div>
                                                        <span class="tr-title">
                                                            <a href="#"
