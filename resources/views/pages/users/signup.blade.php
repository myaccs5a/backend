                    ...
                    <div role="tabpanel" class="tab-pane active" id="seeker">
                        <div class="account-content">
                            <form action="{{ URL::to('/save-signup') }}" class="tr-form" method="post">
                                ...
                                <div class="form-group" >
                                    <label style="float: left;color: #645353">Ngôn ngữ :</label><br>
                                        <select
                                          class="form-control"
                                        ...
                                        >
                                            ...
                                            <option value="{{ $lag->name_language }}">{{ $lag->name_language }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="new-user text-center">
                                <span>Bạn đã có tài khoản? <a href="{{ URL::to('/signin-user') }}"
                                        style="color: cornflowerblue;font-weight: bold">Đăng nhập</a> </span>
                            </div>
                        </div>
                    </div>
