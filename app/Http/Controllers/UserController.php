...
class UserController extends Controller
{
    ...
    public function add_signup()
    {
        ...
        $zones =Zones::all();
        return view('pages.users.signup',['zones'=> $zones,'language'=>$language]);
    }
  ...
  public function getUser(){
    ...
    $user = Auth::user();
    $language = Language::All();
    return view('pages.users.profile',['nguoidung'=>$user,'zones'=> $zones,'language'=>$language]);
  }
  ...
  public function getUserprofile(){
    ...
    return view('pages.users.edit',['nguoidung'=>$user,'zones'=> $zones,'language'=>$language]);
  }
