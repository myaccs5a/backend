...
Route::group(['prefix'=> 'company'],function (){
    ...
    Route::group(['prefix'=> 'job'],function (){
        ...
        Route::get('/check-job/{id}','CompanyUserController@checkJob')->name('job.get.check');
        Route::get('/uncheck-job/{id}','CompanyUserController@unCheckJob')->name('job.get.uncheck');
...
Route::get('/show-search','CompanyUserController@searchUser')->name('company.get.show');
...
//IP//
Route::get('check-ip','Ipcontroller@getTimeZoneUser');
